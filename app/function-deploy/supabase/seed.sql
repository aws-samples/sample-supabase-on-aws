...
-- Grant permissions for cluster management
-- This ensures postgres user can access the _studio.db_instances table
GRANT USAGE ON SCHEMA _studio TO postgres;
GRANT ALL PRIVILEGES ON TABLE _studio.db_instances TO postgres;
