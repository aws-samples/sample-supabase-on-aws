...
let _sslRootCert = process.env.PG_META_DB_SSL_ROOT_CERT
if (_sslRootCert?.startsWith('/')) {
  _sslRootCert = fs.readFileSync(_sslRootCert, 'utf-8')
}
export const PG_META_DB_SSL_ROOT_CERT = _sslRootCert
...
export const DEFAULT_POOL_CONFIG: PoolConfig = {
  ...
  ssl: PG_META_DB_SSL_ROOT_CERT ? { rejectUnauthorized: true, ca: PG_META_DB_SSL_ROOT_CERT } : undefined,
